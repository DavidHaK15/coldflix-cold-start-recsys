...
thái lạnh, trong khi phương pháp lai content + collaborative theo tinh thần
...
Ma trận $R$ thường **cực kỳ thưa** — trong bộ dữ liệu của chúng tôi độ thưa lên
tới khoảng 90%. Cold-start là trường hợp đặc biệt nghiêm trọng của tính thưa,
...
Chúng tôi sử dụng bộ dữ liệu *synthetic có cấu trúc sở thích* gồm **280 phim, 500
người dùng và ~13.520 lượt đánh giá** (16 thể loại). Điểm khác biệt quan trọng:
ratings không sinh ngẫu nhiên mà từ **sở thích tiềm ẩn theo thể loại** của từng
người dùng cộng với "chất lượng" nội tại của phim và một lượng nhiễu nhỏ:
...
- **Frontend** (React 19 + Vite + TypeScript): giao diện xem phim kiểu Netflix —
  ...
  thấy gợi ý thay đổi tức thì. Poster được **sinh bằng CSS gradient** theo tên và
  thể loại, hoạt động hoàn toàn offline.
...
Bảng dưới đây là Recall@10 trung bình theo số tương tác ban đầu (50 người dùng
mẫu):

| Chiến lược | 0 | 1 | 2 | 5 | 10 | 20 |
|---|---|---|---|---|---|---|
| Popularity-based | 0.073 | 0.073 | 0.073 | 0.073 | 0.073 | 0.073 |
| Content-based | 0.034 | 0.019 | 0.036 | 0.034 | 0.025 | 0.050 |
| Onboarding + Item-CF | 0.073 | 0.062 | 0.070 | 0.078 | 0.097 | **0.104** |
| DropoutNet | 0.034 | 0.027 | 0.039 | 0.067 | 0.102 | **0.132** |

*(Con số có thể dao động nhẹ giữa các lần chạy do lấy mẫu ngẫu nhiên.)*

**Quan sát chính:**

1. **Tại 0 tương tác (lạnh hoàn toàn):** Popularity đạt 0.073, cao nhất — vì khi
   chưa biết gì về người dùng, gợi ý phổ biến là lựa chọn an toàn nhất.
2. **Popularity phẳng tuyệt đối:** đường của nó không đổi theo số tương tác — đúng
   bản chất phi cá nhân hoá, không "học" từ hành vi.
3. **Onboarding + Item-CF tăng dần:** từ 0.073 lên 0.104 khi có thêm tương tác,
   cho thấy giá trị của active learning.
4. **DropoutNet vượt trội khi ấm:** khởi đầu thấp (0.034) nhưng đạt **0.132** tại
   20 tương tác — cao hơn Popularity ~81% — nhờ chuyển dần trọng số sang
   collaborative.
